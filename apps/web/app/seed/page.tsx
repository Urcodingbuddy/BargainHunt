        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full">
          <div className="flex flex-col sm:flex-row gap-6 w-full lg:w-3/5">
            ...
            <div className="flex flex-col flex-1">
              <h3 className="text-lg md:text-xl font-bold text-white mb-3 line-clamp-2">{product.title}</h3>
                ...
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-yellow-400">
                      {product.rating}
                      <span className="text-gray-400 text-sm ml-1">out of 5 stars</span>
                    </span>
                  </div>
                  {product.reviews && <span className="text-gray-400 text-sm">({product.reviews} reviews)</span>}
                </div>
              )}
              ...
              <div className="space-y-1 mt-auto">
                ...
                {product.boughtInPastMonth && product.boughtInPastMonth !== "M.R.P:" && (
                  <div className="text-sm text-green-500 font-medium">{product.boughtInPastMonth}</div>
                )}
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        >
                          <img className="h-5 w-5 mr-2" src="/amazon-icon.svg" alt="Amazon" />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <Link
                          ...
                          className="flex items-center"
                        >
                          <img className="h-5 w-5 mr-2" src="/flipkart-icon.svg" alt="Flipkart" />
                          <ExternalLink className="h-3 w-3 ml-1" />
                        </Link>
                      </Button>
                      <div
            ...
            <Card className="bg-black/60 backdrop-blur-xl border border-gray-800 overflow-hidden">
              <div className="p-4 flex flex-col h-full">
                <div className="flex items-center justify-between mb-3">
                  <Badge variant="outline" className="bg-white/10 text-white border-gray-700">
                ...
                <div className="space-y-3 mt-auto">
                  <label htmlFor="brandName" className="text-sm text-gray-300 font-medium">
                    Brand Name
                  </label>
                  <Input
                    id="brandName"
                  ...
                  />
                  <Button className="w-full bg-green-600 hover:bg-green-500 text-white font-medium">Save</Button>
                </div>
              </div>
            </Card>
          </div>
