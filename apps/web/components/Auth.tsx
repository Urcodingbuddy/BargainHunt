...
function Loader() {
  return (
    <div role="status" className="ml-2">
      <svg
        aria-hidden="true"
        className="inline w-5 h-5 text-white animate-spin dark:text-black fill-white dark:fill-white"
        viewBox="0 0 100 101"
        fill="none"
    ...
    <div className="">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full cursor-pointer flex items-center justify-center gap-2 bg-purple-600 hover:bg-transparent border-2 text-white font-medium py-2 px-4 rounded-lg transition-all duration-300 relative"
        >
